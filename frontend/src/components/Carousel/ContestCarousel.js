...
const ContestCarousel = () => {
  ...
  const fetchUpcomingContests = async () => {
    try {
      ...
      setLoading(true);
      const response = await axios.get('http://localhost:5000/getUpcomingContestsData');
      ...
      <div className='carousel_contest'>
        {
          (contest.contestPlatform === 'Atcoder') ? 
            <img src={AtcoderLogo} alt='Atcoder' height="80" style={{marginBottom: 10}} /> : 
          (contest.contestPlatform === 'Codechef') ? 
            <img src={CodechefLogo} alt='Codechef' height="80" style={{marginBottom: 10}} /> :
          (contest.contestPlatform === 'Codeforces') ? 
            <img src={CodeforcesLogo} alt='Codeforces' height="80" style={{marginBottom: 10}} /> :
          (contest.contestPlatform === 'Gfg') ? 
            <img src={GeeksForGeeksLogo} alt='Gfg' height="80" style={{marginBottom: 10}} /> :
          (contest.contestPlatform === 'Leetcode') ? 
            <img src={LeetcodeLogo} alt='Leetcode' height="80" style={{marginBottom: 10}} /> :  
          <img src={TopcoderLogo} alt='Topcoder' height="80" style={{marginBottom: 10}} />
        }
        ...
        <div className='carousel_contestDateTime'>
          <div className='carousel_contestDate'>
            {contest.contestStartDate}
          </div>
          <div className='carousel_contestTime'>
